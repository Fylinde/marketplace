...
const IdVerificationForm: React.FC<IdVerificationFormProps> = ({ data, onUpdate, onNext }) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log('IdVerificationForm submitted:', formData); // Log the form data
