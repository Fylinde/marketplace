  ...
  return (
      ...
      <Routes>
        ...
        {sellerType === 'professional' && (
          <>
            <Route
              path="professional/company-details"
              element={
                <SellerRegistrationLayout currentStep="Company Details">
                  <CompanyDetailsForm data={companyDetails} onUpdate={handleCompanyDetailsUpdate} onNext={() => navigate('/register/seller/professional/business-information')} />
                </SellerRegistrationLayout>
              }
            />
            ...
            <Route
              ...
              element={
                <SellerRegistrationLayout currentStep="Business Information">
                  <BusinessInformationForm
                    data={businessInfo}
                    onUpdate={handleBusinessInformationUpdate}
                    onNext={() => navigate('/register/seller/professional/seller-information')}
                  />
                </SellerRegistrationLayout>
              }
