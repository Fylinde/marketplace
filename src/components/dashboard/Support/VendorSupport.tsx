...
const VendorSupportContainer = styled.div`
  padding: 20px;
...
const VendorSupport: React.FC<VendorSupportProps> = ({ tickets, loading, error, onSelectTicket }) => {
  ...
  return (
    <VendorSupportContainer>
      <h2>{getLocalizedText("Vendor Support", "support")}</h2>
