...
import { updateSellerCurrency } from "../../../redux/slices/orders/currencySlice";
...
const PaymentManagement: React.FC = () => {
  ...
  const handleCryptoToggle = () => {
    dispatch(toggleCryptoAcceptance(!cryptoAcceptance)); // Toggle the current state
    ...
    <Box>
      ...
      <Box>
        ...
        <Table>
          ...
          <tbody>
            {escrowDetails.map((escrow: EscrowTransaction) => (
